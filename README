...
I am available as freelancer so I can provide you an updated a version that is tested against other OWASP security vulnerabilities, you can contact me <a href="https://example.com/">here</a>.
